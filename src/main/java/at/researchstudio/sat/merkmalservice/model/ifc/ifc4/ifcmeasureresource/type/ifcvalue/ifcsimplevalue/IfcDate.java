...
public class IfcDate extends IfcSimpleValue<String> {
    // pattern as defined in
    // https://standards.buildingsmart.org/IFC/RELEASE/IFC4/ADD1/HTML/link/ifcdate.htm
    private Pattern pattern = Pattern.compile("-?\\d*\\d{4}-\\d{2}-\\d{2}(.+)?");
